...
const bodyImage = {
    backgroundImage: 'url("images/Login-body.png")'
}
    ...
    <div style = {Container}>
        ...
        <div style= {colmd4}> 
           ...
           <center>
               ...
               <h2> SIGN IN </h2>
                <h4 style = {h4Style}> Hello there. Sign in and start managing your bank items </h4> 

                <div style = {{ width: '100%', marginTop: '40px'}}>
                       <div style = {colmd12}>
                        <p style={lefty}><b>email</b></p>
                        <input type = "email" style ={textBoxStyle}></input>
                    </div>

                    <div style = {{ width: '100%', marginTop: '15px'}}>
                        <p style={lefty}><b>password</b></p>
                        <input type = "password" style ={textBoxStyle}></input>
                    </div>


                    <div style = {{ width: '100%', marginTop: '50px'}}>
                    <button style = {buttonStyle}>SIGN IN NOW <b>:)</b></button>
                    </div>

                    <p> Forgot Password?<a> Reset Here.</a>  </p>

                    <p style = {{marginTop: '40px', fontSize: '12px'}}> &copy; Spenc Note Inc. All rights reserved 2006</p>
                </div>
